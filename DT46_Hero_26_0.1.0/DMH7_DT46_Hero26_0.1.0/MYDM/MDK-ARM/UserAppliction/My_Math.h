...
double MyMath_cal_output_angle(double CurentAngle,uint16_t gear_ratio);//使用减速比计算输出角度
double MyMath_cal_output_radangle(double current_rad, uint16_t gear_ratio);// 知道当前编码器弧度和减速比，求输出轴角度(1ms调用)
#endif 

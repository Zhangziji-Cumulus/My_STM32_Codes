...
void Gimbal_Update(void)
{
    ...
    //获取IMU当前角度
    Gimbal_Instance.Calc.Yaw.C_Angle = Gimbal_Instance.INS_angle[GIMBAL_IMU_INDEX_YAW];
    Gimbal_Instance.Calc.Pitch.C_Angle = Gimbal_Instance.INS_angle[GIMBAL_IMU_INDEX_PITCH];
    
    Gimbal_Instance.Calc.Pitch.C_Angle = MyMath_Limit_Float(
                                            Gimbal_Instance.Calc.Pitch.C_Angle,
                                            -GIMBAL_PITCH_MAX_ELE,GIMBAL_PITCH_MAX_DEP,0);
    ...
    Gimbal_Instance.MotorData.Yaw = Gimbal_Instance.MotorData.Ptr[GIMBAL_MOTOR_ID_FBK_PITCH];
...
static void Gimbal_Update_Target(void)
{
    ...
    Gimbal_Instance.Calc.Yaw.T_Angle = Gimbal_Instance.Calc.Yaw.T_Angle
                                        - MyMath_Map_Range(AddYaw,-CMD_CTRL_RANGE,CMD_CTRL_RANGE,-0.25f,0.25f);
    //限幅角度-180 ~ 180 循环模式
    ...
    Gimbal_Instance.Calc.Pitch.T_Angle = Gimbal_Instance.Calc.Pitch.T_Angle
                                        - MyMath_Map_Range(AddPitch,-CMD_CTRL_RANGE,CMD_CTRL_RANGE,-0.25f,0.25f);
    //限幅俯仰角，非循环模式
